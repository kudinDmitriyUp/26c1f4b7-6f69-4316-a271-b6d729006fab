...
export const metadata: Metadata = {
  title: "TechVenture Capital - Modern VC Fund for Innovative Startups",
  description: "Invest in groundbreaking technology startups. TechVenture Capital provides funding, mentorship, and strategic guidance to early-stage founders building the future.",
  keywords: "venture capital, VC fund, startup investment, early-stage funding, tech innovation",
  metadataBase: new URL("https://techventure.com"),
  alternates: {
    canonical: "https://techventure.com"
  },
  openGraph: {
    title: "TechVenture Capital - VC Fund for Innovative Startups",
    description: "Invest in groundbreaking technology startups with strategic capital and mentorship.",
    type: "website",
    siteName: "TechVenture Capital"
  },
  twitter: {
    card: "summary_large_image",
    title: "TechVenture Capital - VC Fund",
    description: "Invest in the future of technology with TechVenture Capital."
  },
  robots: {
    index: true,
    follow: true
